...
Ledgerly is a personal-finance ETL pipeline that reads DBS bank transaction alert emails out of Gmail, uses an LLM to categorize each one, and stores them in Google Sheet
